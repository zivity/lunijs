...
var Lunicorn = function () {
  ...
  _createClass(Lunicorn, [{
    ...
    value: function createIframe(parentDomID, iframeUrl) {
      return new Lunicorn(new _pym2.default.Parent(parentDomID, iframeUrl, {}));
    }
  }, {
    key: "consumeIframe",
    value: function consumeIframe() {
      var pollingInterval = arguments.length <= 0 || arguments[0] === undefined ? 100 : arguments[0];

      return new Lunicorn(new _pym2.default.Child({ polling: pollingInterval }));
    }
  }]);
